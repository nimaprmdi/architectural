...
const SelectedWorks = () => {
  ...
  return (
    <div className="c-selected-work w-full">
      <div className="c-selected-work__header w-full  pt-32 bg-green-500 ">
      ...
      <div className="w-full" style={{ height: "650px" }}>
        ...
        >
          <SwiperSlide className="w-full h-52 bg-slate-900 text-white">
            <div className="slider__images w-4/6 h-full flex justify-center bg-red-400 relative items-center">
            ...
            <div className="slider__context w-2/6 bg-blue-600"></div>
          </SwiperSlide>
        </Swiper>
      </div>
    </div>
